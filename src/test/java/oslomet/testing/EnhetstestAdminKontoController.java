...
public class EnhetstestAdminKontoController {
    ...
    public void hentAlleKonti_loggetInnOK(){
        ...
        Transaksjon t1 = new Transaksjon(1, "123", 50,
                "01.01.2022", "til øl", "godkjent", "456");
        Transaksjon t2 = new Transaksjon(2, "123", 180,
                "01.12.2022", "middag", "godkjent", "456");
        Transaksjon t3 = new Transaksjon(3, "123", 5,
                "01.24.2022", "vipps", "avventer", "456");
        transkasjoner.add(t1);
        transkasjoner.add(t2);
        transkasjoner.add(t3);

        List<Konto> alleKontoer = new ArrayList<>();
        Konto konto1 = new Konto("123456", "123",
                150.15, "brukskonto", "NOK", transkasjoner);
        Konto konto2 = new Konto("34523523", "456",
                18.15, "sparekonto", "USD", transkasjoner);
    ...
    public void hentAlleKonti_ikkeloggetInn(){
        ...
        List<Konto> alleKontoer = new ArrayList<>();
        Konto konto1 = new Konto("123456", "123", 150.15,
                "brukskonto", "NOK", transkasjoner);
        Konto konto2 = new Konto("34523523", "456", 18.15,
                "sparekonto", "USD", transkasjoner);
        alleKontoer.add(konto1);
        alleKontoer.add(konto2);
    ...
    public void registrerKonto_loggetInnOK(){
        List<Transaksjon> transkasjoner = new ArrayList<>();
        Konto konto = new Konto("123456", "123",
                150.15, "brukskonto", "NOK", transkasjoner);
    ...
    public void registrerKonto_loggetInnFeil(){
        List<Transaksjon> transkasjoner = new ArrayList<>();
        Konto konto = new Konto("0", "123", 150.15,
                "brukskonto", "NOK", transkasjoner);
    ...
    public void registrerKonto_ikkeloggetInn(){
        List<Transaksjon> transkasjoner = new ArrayList<>();
        Konto konto = new Konto("123456", "123", 150.15,
                "brukskonto", "NOK", transkasjoner);
